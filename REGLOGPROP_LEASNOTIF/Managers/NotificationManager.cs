...
namespace REGLOGPROP_LEASNOTIF.Managers
{
    public class NotificationManager
    {
        ...
        //public void ReadNotifications(string leaseId, string ownerId)
        //{
        //    using (var context = new Context())
        //    {
        //        var notifications = context.Set<Notification>().Where(n => n.sendersId == leaseId || n.sendersId == ownerId || n.receiversId == leaseId || n.receiversId == ownerId).ToList();
        //        if (notifications.Count > 0)
        //        {
        //            Console.WriteLine("\t\tNotifications:");
        //            foreach (var notification in notifications)
