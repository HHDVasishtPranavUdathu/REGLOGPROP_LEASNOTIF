...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Lease", b =>
                {
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Maintainance", b =>
                {
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Paymennts", b =>
                {
                    ...
                    b.Property<string>("TenantDetailsID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("TenantDetailsID");

                    b.ToTable("payments");
                });

            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Prop", b =>
                {
                    b.Property<int>("Property_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Registration", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Lease", b =>
                {
                    b.HasOne("REGLOGPROP_LEASNOTIF.Models.Registration", "Tenant")
                        .WithMany()
                        .HasForeignKey("ID");

                    b.HasOne("REGLOGPROP_LEASNOTIF.Models.Prop", "Prop")
                        .WithMany()
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Paymennts", b =>
                {
                    b.HasOne("REGLOGPROP_LEASNOTIF.Models.Registration", "TenantDetails")
                        .WithMany()
                        .HasForeignKey("TenantDetailsID");
            ...
            modelBuilder.Entity("REGLOGPROP_LEASNOTIF.Models.Prop", b =>
                {
                    b.HasOne("REGLOGPROP_LEASNOTIF.Models.Registration", "Registration")
                        .WithMany()
